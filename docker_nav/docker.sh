...
# Configuration
IMAGE_NAME="objectnavigation"
IMAGE_TAG="latest"
FULL_IMAGE="${IMAGE_NAME}:${IMAGE_TAG}"
CONTAINER_NAME="objectnavigation-container"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help)
            ...
            echo ""
            echo "After running, your ROS 2 workspace will be at:"
            echo "  /omnigibson-src/ros2_nav"
            exit 0
            ;;
        *)
...
if [ "$ACTION" = "build" ]; then
    echo -e "${BLUE}=========================================="
    echo "Building ObjectNavigation Image"
    echo -e "==========================================${NC}"
    echo ""
    ...
    echo ""
    echo "Your ROS 2 workspace will be located at:"
    echo "  /omnigibson-src/ros2_nav"
    echo ""
...
if [ "$ACTION" = "run" ]; then
    ...
    # EULA acceptance
    #Interactive mode for EULA acceptance has been disabled for simplicity.
    ...
    # echo ""
    # Automatically accept NVIDIA Omniverse EULA (non-interactive)
    echo -e "${GREEN}Automatically accepting NVIDIA Omniverse EULA...${NC}"
    ...
    echo "Working directory: /omnigibson-src/ros2_nav"
    echo ""
